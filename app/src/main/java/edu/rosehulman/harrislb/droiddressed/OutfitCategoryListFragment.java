 ...
 */
public class OutfitCategoryListFragment extends Fragment {
    private OutfitCategoryAdapter mAdapter;

    private OnOutfitCategorySelectedListener mListener;
    private Toolbar mToolbar;

    public OutfitCategoryListFragment() {
...
//        registerForContextMenu(recyclerView);
        ...
        mAdapter = new OutfitCategoryAdapter(this, mListener);
