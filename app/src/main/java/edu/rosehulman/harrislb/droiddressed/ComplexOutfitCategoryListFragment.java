 ...
 */
public class ComplexOutfitCategoryListFragment extends Fragment {
    private ComplexOutfitCategoryAdapter mAdapter;

    private OnOutfitCategorySelectedListener mListener;
    private Toolbar mToolbar;

    public ComplexOutfitCategoryListFragment() {
...
//        registerForContextMenu(recyclerView);
        ...
        mAdapter = new ComplexOutfitCategoryAdapter(this, mListener);
...
//    }
    ...
    public void showCategoryDialog(final OutfitCategory category) {
    ...
    private void showDeleteConfirmationDialog(final OutfitCategory category) {
        DialogFragment df = new DialogFragment() {
            @Override
            @NonNull
            public Dialog onCreateDialog(Bundle savedInstanceState) {
                ...
                builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Util.removeOutfitCategory(getActivity(), category);
                        dismiss();
                    }
                });
                builder.setNegativeButton(android.R.string.cancel, null);
...
//        if (context instanceof OnOutfitCategorySelectedListener) {
//            mListener = (OnOutfitCategorySelectedListener) context;
//        } else {
//            throw new RuntimeException(context.toString()
//                    + " must implement OnOutfitCategorySelectedListener");
//        }
//    }
//
//    @Override
...
//    }
    ...
    public interface OnOutfitCategorySelectedListener {
        void onOutfitCategorySelected(OutfitCategory selectedCategory);
    }
}
