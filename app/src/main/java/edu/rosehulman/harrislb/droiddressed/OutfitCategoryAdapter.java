 ...
 */
public class OutfitCategoryAdapter extends RecyclerView.Adapter<OutfitCategoryAdapter.ViewHolder> {

    private final OutfitCategoryListFragment mOutfitCategoryListFragment;

    private final OutfitCategoryListFragment.OnOutfitCategorySelectedListener mOutfitCategorySelectedListener;
    private String mUid;
    ...
    public OutfitCategoryAdapter(OutfitCategoryListFragment outfitCategoryListFragment, OutfitCategoryListFragment.OnOutfitCategorySelectedListener listener) {
        ...
        mOutfitCategoriesRef = new Firebase(Constants.OUTFIT_CATEGORY_PATH);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void onClick(View v) {
           ...
           // mOutfitCategorySelectedListener.onOutfitCategorySelected(category);

            FragmentTransaction ft = mOutfitCategoryListFragment.getActivity().getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.fragment_container, OutfitListFragment.newInstance(category.getKey()));
